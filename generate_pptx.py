...
# ------------------------------------------------------------------
# Slide 13: Glossary of Technical Terms
# ------------------------------------------------------------------
s13 = prs.slides.add_slide(prs.slide_layouts[6])
add_bg(s13); add_title_bar(s13, 'Glossary of Marketing & Econometric Terms', 'Plain-English definitions & real-world analogies')

glossary_items = [
    'Adstock (Ad Memory Decay): Advertising impact does not vanish immediately; a fraction carries over into future weeks/months (e.g. coffee carryover effect).',
    'Log-Saturation (Diminishing Returns): As ad spend increases, each additional dollar generates less sales lift because high-intent audiences become exhausted (e.g. 1st vs 10th pizza slice).',
    'Marginal ROI: The extra revenue generated by spending the NEXT $1 today ($7.07 Radio vs $1.32 Digital). Contrasts with historical average ROI.',
    'Standardised Coefficient (β*): Scales channel drivers from -1 to +1 so we can compare "apples to elephants" across different measurement units.',
    'P-Value & Significance: Probability that a result was caused by random luck. p < 0.05 means <5% chance of luck (statistically significant).',
    'LOOCV R-Squared: Leave-One-Out Cross Validation accuracy. Tests model predictions on hidden out-of-sample data to ensure zero overfitting.',
    'HC3 Robust Standard Errors: A small-sample correction (n=36) that prevents false-positive claims caused by unequal error variances.',
]
add_bullet_list(s13, Inches(0.7), Inches(1.7), Inches(11.8), Inches(5.3), glossary_items, size=12)
